...
export const SHORTCUTS = Object.freeze({
  ...
  BULLET_LIST: IS_APPLE ? '⌘+Shift+7' : 'Ctrl+Shift+7',
  NUMBERED_LIST: IS_APPLE ? '⌘+Shift+8' : 'Ctrl+Shift+8',
  ...
  CAPITALIZE: IS_APPLE ? '⌃+Shift+1' : 'Ctrl+Shift+1',
  LOWERCASE: IS_APPLE ? '⌃+Shift+2' : 'Ctrl+Shift+2',
