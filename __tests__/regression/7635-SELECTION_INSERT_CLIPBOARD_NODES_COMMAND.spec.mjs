...
function assertHTMLIgnoreInlineStyles(
  page,
  isCollab,
  browserName,
  expectedHtml,
  ...
  return assertHTML(page, isCollab, browserName, expectedHtml, expectedHtml, {
...
test.describe('Regression #7635', () => {
  ...
  test('Paste into image caption', async ({
    page,
    isPlainText,
    isCollab,
    legacyEvents,
    ...
    test.skip(isPlainText || isCollab || legacyEvents);
