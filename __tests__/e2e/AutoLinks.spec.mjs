...
test.describe.parallel('Auto Links', () => {
  ...
  test('Can destruct links if add non-spacing text in front or right after it', async ({
    ...
    await assertHTML(page, isCollab, browserName, htmlWithLink, undefined, {
      ignoreClasses: true,
    });
  ...
  test('Does not create redundant auto-link', async ({
    page,
    isPlainText,
    isCollab,
    browserName,
  ...
  test('Handles multiple autolinks in a row', async ({
    page,
    isPlainText,
    isCollab,
    browserName,
  ...
  test.describe('Can convert URL into an autolink', () => {
    [
      ...
      test(testUrl, async ({page, isPlainText, isCollab, browserName}) => {
        test.skip(isPlainText);
        await focusEditor(page, isCollab);
  ...
  test(`Can not convert bad URLs into links`, async ({
    page,
    isPlainText,
    isCollab,
    browserName,
  ...
  test('Can unlink the autolink and then make it link again', async ({
    ...
    await focusEditor(page, isCollab);
    await click(page, isCollab, 'a[href="http://www.example.com"]');
    await click(page, isCollab, 'div.link-editor div.link-trash');
    ...
    await click(page, isCollab, 'span:has-text("http://www.example.com")');

    pressInsertLinkButton(page, isCollab);
