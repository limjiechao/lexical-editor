...
export async function moveToEditorBeginning(page, browserName) {
  if (IS_MAC) {
    await keyDownCtrlOrMeta(page);
...
export async function moveToEditorEnd(page, browserName) {
  if (IS_MAC) {
    await keyDownCtrlOrMeta(page);
...
export async function selectAll(page, isCollab, browserName) {
  // TODO Normalize #4665
