...
test.describe('File', () => {
  ...
  test(`Can import/export`, async ({
    ...
    await insertUploadImage(page, isCollab, [
    ...
    const [download] = await Promise.all([
      ...
      click(page, isCollab, '.action-button.export'),
    ]);
    ...
    await click(page, isCollab, '.action-button.import');
    await sleep(200);
