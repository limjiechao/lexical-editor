...
test.describe.parallel('TextFormatting', () => {
  ...
  test('Should not format the text in the subsequent paragraph after a triple click selection event.', async ({
    ...
    await click(page, isCollab, 'div[contenteditable="true"] > p', {
      clickCount: 1,
      delay: 100,
    });
    await click(page, isCollab, 'div[contenteditable="true"] > p', {
  ...
  test(`Can select text and underline+strikethrough`, async ({
    ...
    await click(page, isCollab, '.strikethrough');
  ...
  test(`Can select text and decrease the font-size`, async ({
    ...
    await click(page, isCollab, '.font-decrement');
  ...
  test(`Can select text and change the font-size and font-family`, async ({
    ...
    await click(page, isCollab, '.font-family');
    await click(page, isCollab, 'button:has-text("Georgia")');
  ...
  test(
    ...
    {tag: '@flaky'},
    async ({page, isCollab, isPlainText, browserName, environment}) => {
      test.skip(isPlainText);
      await focusEditor(page, isCollab);
