...
test.describe('TextEntry', () => {
  ...
  test(`Can type 'Hello Lexical' in the editor`, async ({
    page,
    isCollab,
    browserName,
  }) => {
  ...
  test('Paragraphed text entry and selection', async ({
    page,
    isRichText,
    isCollab,
    browserName,
  ...
  test('First paragraph backspace handling', async ({
    page,
    isRichText,
    isCollab,
    browserName,
  ...
  test('Mix of paragraphs and break points', async ({
    page,
    isRichText,
    isCollab,
    browserName,
