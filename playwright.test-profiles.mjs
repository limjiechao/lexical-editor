...
export const EDITOR_MODES = {
  COLLAB_V1_RICH: 'collab_v1_rich',
  COLLAB_V2_PLAIN: 'collab_v2_plain',
...
export const TEST_PROFILE_03_C_CR_M_LD = `${BROWSERS.CHROMIUM}-${EDITOR_MODES.COLLAB_V1_RICH}-${EVENTS_MODES.MODERN}-${ENVIRONMENTS.LOCAL_DEV}`;
...
export const TEST_PROFILE_06_W_CR_M_LD = `${BROWSERS.WEBKIT}-${EDITOR_MODES.COLLAB_V1_RICH}-${EVENTS_MODES.MODERN}-${ENVIRONMENTS.LOCAL_DEV}`;
...
export const TEST_PROFILE_09_F_CR_M_LD = `${BROWSERS.FIREFOX}-${EDITOR_MODES.COLLAB_V1_RICH}-${EVENTS_MODES.MODERN}-${ENVIRONMENTS.LOCAL_DEV}`;
...
export const TEST_PROFILE_11_C_CR_L_LD = `${BROWSERS.CHROMIUM}-${EDITOR_MODES.COLLAB_V1_RICH}-${EVENTS_MODES.LEGACY}-${ENVIRONMENTS.LOCAL_DEV}`;
export const TEST_PROFILE_12_W_SR_L_LD = `${BROWSERS.WEBKIT}-${EDITOR_MODES.SOLO_RICH}-${EVENTS_MODES.LEGACY}-${ENVIRONMENTS.LOCAL_DEV}`;
export const TEST_PROFILE_13_W_CR_L_LD = `${BROWSERS.WEBKIT}-${EDITOR_MODES.COLLAB_V1_RICH}-${EVENTS_MODES.LEGACY}-${ENVIRONMENTS.LOCAL_DEV}`;
...
export const TEST_PROFILE_15_F_CR_L_LD = `${BROWSERS.FIREFOX}-${EDITOR_MODES.COLLAB_V1_RICH}-${EVENTS_MODES.LEGACY}-${ENVIRONMENTS.LOCAL_DEV}`;
...
const TEST_PROFILES = {
  ...
  [TEST_PROFILE_03_C_CR_M_LD]: {
    EDITOR_MODE: EDITOR_MODES.COLLAB_V1_RICH,
    ENVIRONMENT: ENVIRONMENTS.LOCAL_DEV,
    EVENTS_MODE: EVENTS_MODES.MODERN,
  },
...
export function getTestProfile(testProfileName) {
  return {
    ...
    isCollab:
      TEST_PROFILES[testProfileName].EDITOR_MODE === 'collab_v1_rich' ||
      TEST_PROFILES[testProfileName].EDITOR_MODE === 'collab_v2_plain',
    isCollabV1: TEST_PROFILES[testProfileName].EDITOR_MODE === 'collab_v1_rich',
    isCollabV2:
      TEST_PROFILES[testProfileName].EDITOR_MODE === 'collab_v2_plain',
