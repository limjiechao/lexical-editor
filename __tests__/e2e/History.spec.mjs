...
test.describe('History', () => {
  ...
  test(
    ...
    {tag: '@flaky'},
    async ({isRichText, page, isCollab, browserName}) => {
      test.skip(isCollab);
  ...
  test('Can coalesce when switching inline styles (#1151)', async ({
    ...
    await assertHTML(page, isCollab, browserName, step1HTML);
    await undo(page);
    await assertHTML(page, isCollab, browserName, step2HTML);
    await undo(page);
    await assertHTML(page, isCollab, browserName, step3HTML);
    await undo(page);
    await assertHTML(page, isCollab, browserName, step4HTML);
    await redo(page);
    await assertHTML(page, isCollab, browserName, step3HTML);
    await redo(page);
    await assertHTML(page, isCollab, browserName, step2HTML);
